...
ActiveRecord::Schema.define(:version => 20120416154254) do
  ...
  create_table "accounts", :force => true do |t|
    ...
    t.time     "session_expired_at"
    t.string   "email"
  end

  add_index "accounts", ["email"], :name => "index_accounts_on_email", :unique => true
  add_index "accounts", ["session_expired_at"], :name => "index_accounts_on_session_expired_at"
  ...
  add_index "playings", ["account_id"], :name => "index_playings_on_account_id"
  ...
  add_index "servers", ["locale"], :name => "index_servers_on_locale"
